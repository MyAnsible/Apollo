...
ATLAS_ARTIFACT_MASTER=${ATLAS_ARTIFACT_MASTER:-Enxebre/apollo-mesos-ubuntu-14.04-amd64}
ATLAS_ARTIFACT_SLAVE=${ATLAS_ARTIFACT_SLAVE:-Enxebre/apollo-mesos-ubuntu-14.04-amd64}
